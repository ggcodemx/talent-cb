...
export const LiderazgoPageGlobal: GlobalConfig = {
  slug: 'page-liderazgo',
  label: ' Página: Liderazgo',
  access: { read: () => true },
  fields: [
    // ─── Hero ──────────────────────────────────────────────────────────────
    {
      ...
      fields: [
        {
          ...
          fields: [
            ...
            { name: 'description', type: 'textarea', label: 'Descripción (reverso)', required: true, admin: { rows: 4 } },
            { name: 'image', type: 'upload', relationTo: 'media', label: 'Imagen de fondo', required: true },
          ],
        },
        {
          name: 'cardRight',
