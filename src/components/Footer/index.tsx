...
const footerLinks = {
  'Nuestra firma': [
    ...
    { label: 'Visión e impacto', href: '/vision-e-impacto' },
    { label: 'Liderazgo', href: '/liderazgo' },
    { label: 'Carreras', href: '/carreras' },
  ],
  'Experiencia y servicios': [
    { label: 'Nuestras capacidades', href: '/capacidades' },
    { label: 'Experiencia por industria', href: '/industrias' },
    { label: 'Nearshoring estratégico', href: '/nearshoring' },
      ...
      <div className="page-padding py-14">
          ...
          <div className="flex flex-col gap-4">
            <Link href="/">
              <Image
                ...
                width={130}
                height={40}
                className="h-17 w-auto brightness-0 invert"
              />
            </Link>
        ...
        <div className="border-t border-white mt-12 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white text-sm font-medium">
            2026 CB Tax. Todos los derechos reservados.
          </p>
          <Link
